...
* Студент: [Виктория Журавлёва](https://up.htmlacademy.ru/htmlcss/29/user/63754).
* Наставник: [Мастер Кекс].
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/63754-technomart-29) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
